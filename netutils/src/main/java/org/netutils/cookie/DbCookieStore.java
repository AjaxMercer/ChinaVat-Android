...
public enum DbCookieStore implements CookieStore {
    ...
    DbCookieStore() {
        db = DBUtils.getDb(DbConfigs.COOKIE.getConfig());
        trimSize();
    }
    ...
    public List<URI> getURIs() {
        ...
        try {
            List<org.dbutils.db.table.DbModel> uriList = db.selector(CookieEntity.class).select("uri").findAll();
            if (uriList != null) {
