...
import org.dbutils.db.task.PriorityRunnable;
            ...
            try {
                switch (msg.what) {
                    ...
                    case MSG_WHAT_ON_CANCEL: {
                        ...
                        assert args != null;
                        taskProxy.task.onCancelled((org.netutils.callback.Callback.CancelledException) args[0]);
                        break;
                    }
