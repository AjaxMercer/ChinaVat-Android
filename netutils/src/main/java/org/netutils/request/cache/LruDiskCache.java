package org.netutils.request.cache;


import android.text.TextUtils;

import org.dbutils.db.DBUtils;
import org.dbutils.db.DbManager;
import org.dbutils.db.common.IOUtil;
import org.dbutils.db.common.MD5;
import org.dbutils.db.config.DbConfigs;
import org.dbutils.db.ex.DbException;
import org.dbutils.db.sqlite.WhereBuilder;
import org.dbutils.db.task.PriorityExecutor;
import org.netutils.common.FileUtil;
import org.netutils.common.LogUtil;
import org.netutils.common.ProcessLock;
import org.netutils.ex.FileLockedException;
...
public final class LruDiskCache {
    ...
    private LruDiskCache(String dirName) {
        this.cacheDb = DBUtils.getDb(DbConfigs.HTTP.getConfig());
